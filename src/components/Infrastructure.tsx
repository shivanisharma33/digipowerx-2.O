    ...
    <div className="bg-[#06070a] min-h-screen text-white font-sans selection:bg-[#f5c518]/30 overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto text-center flex flex-col items-center">
          ...
          >
            ...
            {/* Title */}
            <h1 className="text-[clamp(3.5rem,10vw,130px)] font-black tracking-tight leading-[0.82] text-center mb-10">
          ...
          >
            {[
              ...
              <div key={i} className="p-10 flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-white/5 last:border-0 group hover:bg-white/5 transition-colors">
                <span className="text-[#f5c518] font-mono text-3xl font-black mb-2 tracking-tighter">{stat.val}</span>
                <span className="text-[9px] text-white/40 uppercase tracking-[0.2em] font-bold text-center leading-tight">{stat.label}</span>
              </div>
            ))}
          </motion.div>
        </div>
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="flex justify-center mb-12">
            <div className="inline-flex items-center px-6 py-2.5 rounded-full border border-black/10 bg-black/5 backdrop-blur-sm">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.4em] text-black/80">
                Power Flow
              </span>
            </div>
          </div>
          ...
          <div className="text-center mb-8">
            <h2 className="text-5xl md:text-[100px] font-black tracking-[-0.04em] leading-[0.9] text-black uppercase">
              From Generation<br />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {[
                ...
                <div key={i} className="bg-[#f5f5f5] p-10 rounded-xl flex items-start gap-5 border border-black/[0.03] shadow-sm hover:shadow-md transition-all group">
                  ...
                  <p className="text-black/80 font-bold text-sm md:text-base leading-[1.4] tracking-tight">
                    {text}
                  </p>
                </div>
              ))}
            ...
            {/* Right Column: Technical Diagram (Matching User's Image) */}
            <div className="bg-[#06070a] rounded-[24px] p-6 md:p-8 relative overflow-hidden flex flex-col justify-center min-h-[360px] shadow-2xl">
              {/* Subtle Grid Background */}
              <div className="absolute inset-0 opacity-[0.03] pointer-events-none" 
                   style={{ backgroundImage: 'radial-gradient(circle, #fff 1px, transparent 1px)', backgroundSize: '20px 20px' }}></div>
              
              <div className="relative z-10 flex flex-row items-center justify-between gap-3 md:gap-4 scale-95 origin-center">
                
                {/* Cage A */}
                <div className="flex-1 flex flex-col gap-2">
                  <div className="border border-[#f5c518]/30 bg-[#f5c518]/5 rounded-xl p-3 md:p-4 flex flex-col h-[240px]">
                    <div className="text-[#f5c518] text-[8px] font-black uppercase tracking-widest text-center mb-4">Cage A</div>
                    <div className="flex-1 flex gap-1.5">
                      {[...Array(4)].map((_, i) => (
                        <div key={i} className="flex-1 flex flex-col gap-[2px]">
                          {[...Array(20)].map((_, j) => (
                            <div key={j} className={`h-[1.5px] w-full bg-[#f5c518]/20 rounded-full ${i === 3 && j === 2 ? 'bg-[#00ff9d] shadow-[0_0_8px_#00ff9d]' : ''}`}></div>
                          ))}
                        </div>
                      ))}
                    </div>
                ...
                <div className="flex-1 flex flex-col gap-2">
                  <div className="border border-[#f5c518]/30 bg-[#f5c518]/5 rounded-xl p-3 md:p-4 flex flex-col h-[240px]">
                    <div className="text-[#f5c518] text-[8px] font-black uppercase tracking-widest text-center mb-4">Cage B</div>
                    <div className="flex-1 flex gap-2">
                      {[...Array(3)].map((_, i) => (
                        <div key={i} className="flex-1 flex flex-col gap-[3px]">
                          {[...Array(15)].map((_, j) => (
                            <div key={j} className={`h-[2px] w-full bg-[#f5c518]/20 rounded-full ${i === 1 && j === 8 ? 'bg-[#f5c518] shadow-[0_0_8px_#f5c518]' : ''}`}></div>
                          ))}
                        </div>
                      ))}
                    </div>
                ...
                {/* Patch Panel */}
                <div className="w-[80px] md:w-[110px] flex flex-col gap-2">
                  <div className="border border-[#00ff9d]/30 bg-[#00ff9d]/5 rounded-xl p-3 md:p-4 flex flex-col h-[240px] items-center">
                    <div className="text-[#00ff9d] text-[8px] font-black uppercase tracking-widest text-center mb-8 leading-tight">Patch<br/>Panel</div>
                    <div className="grid grid-cols-4 gap-1.5 md:gap-2">
                      {[...Array(24)].map((_, i) => (
                        <div key={i} className={`w-1 h-1 md:w-1.5 md:h-1.5 rounded-full ${i > 10 && i < 20 && Math.random() > 0.3 ? 'bg-[#00ff9d] shadow-[0_0_10px_#00ff9d]' : 'bg-[#00ff9d]/10'}`}></div>
                      ))}
                    </div>
                  </div>
                </div>
                ...
                <div className="w-[100px] md:w-[130px]">
                  <div className="border border-[#00d1ff]/30 bg-[#00d1ff]/5 rounded-xl p-4 md:p-6 flex items-center justify-center h-[160px] text-center">
                    <span className="text-[#00d1ff] text-[8px] font-black uppercase tracking-widest leading-relaxed">
                      Carrier<br/>Neutral<br/>MMR
                    </span>
                  </div>
                </div>
              ...
              <svg className="absolute inset-0 pointer-events-none z-0 opacity-50" width="100%" height="100%">
                <path d="M 200 150 Q 250 130 300 150" stroke="#f5c518" strokeWidth="1" strokeDasharray="3 3" fill="none" opacity="0.2" />
                <path d="M 400 160 Q 450 160 500 180" stroke="#00ff9d" strokeWidth="1" strokeDasharray="3 3" fill="none" opacity="0.2" />
              </svg>

              {/* Bottom Label */}
              <div className="absolute bottom-4 left-8">
                <span className="text-[7px] md:text-[8px] font-mono text-white/20 uppercase tracking-[0.4em]">
                  Inner Tier Data Center — DigiPowerX Campus 1
                </span>
              </div>
            </div>
      ...
      <section className="bg-[#06070a] py-24 px-6 border-y border-white/5">
        <div className="max-w-[1400px] mx-auto">
          ...
          {/* Heading */}
          <div className="text-center mb-8">
            <h2 className="text-4xl md:text-7xl font-black tracking-tight text-white uppercase leading-[1.1]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 border border-white/10 rounded-2xl overflow-hidden bg-white/[0.02]">
            ...
            <div className="p-10 md:p-14 border-b md:border-b-0 md:border-r border-white/10 hover:bg-white/[0.02] transition-colors group">
              <div className="text-[#f5c518] text-[10px] font-black uppercase tracking-[0.2em] mb-4">Generation</div>
              <h3 className="text-white text-xl md:text-2xl font-black uppercase mb-6 tracking-tight">Energy Asset Base</h3>
            ...
            {/* Column 2: Substation */}
            <div className="p-10 md:p-14 border-b md:border-b-0 md:border-r border-white/10 hover:bg-white/[0.02] transition-colors group">
              <div className="text-[#f5c518] text-[10px] font-black uppercase tracking-[0.2em] mb-4">Substation</div>
              <h3 className="text-white text-xl md:text-2xl font-black uppercase mb-6 tracking-tight">Electrical Control Point</h3>
              <p className="text-white/40 text-sm leading-relaxed mb-10 font-medium">
            ...
            <div className="p-10 md:p-14 hover:bg-white/[0.02] transition-colors group">
              <div className="text-[#f5c518] text-[10px] font-black uppercase tracking-[0.2em] mb-4">Compute</div>
              <h3 className="text-white text-xl md:text-2xl font-black uppercase mb-6 tracking-tight">Demand Layer</h3>
              <p className="text-white/40 text-sm leading-relaxed mb-10 font-medium">
      ...
      <section className="bg-white py-24 px-6">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="text-center mb-10">
            <h2 className="text-4xl md:text-7xl font-black tracking-tight text-black uppercase leading-[1]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
            {[
              ...
              <div key={i} className="bg-[#f2f2f2] p-10 rounded-xl flex flex-col items-center text-center group hover:bg-[#f5c518]/5 transition-colors border border-black/[0.03]">
                <h3 className="text-black text-xl font-black uppercase mb-6 tracking-tight">{card.title}</h3>
          ...
          <div className="max-w-[1400px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8">
            {[
              ...
              <div key={i} className="flex flex-col gap-4 border-l border-white/10 pl-8 first:border-0">
                <span className="text-[#f5c518] text-3xl font-black tracking-tight">{stat.val}</span>
                <span className="text-white/40 text-[9px] font-bold uppercase tracking-widest leading-tight">
                  {stat.label}
                </span>
              </div>
            ))}
